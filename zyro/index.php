<?php
	...
	$base_lang = 'en';
	$site_id = "8e9188dd";
	$websiteUID = "916d3be46bf60c47349792927171d60813ca0faa821f3cf4aade8bfd82ba54af6f80aef1c50cef75";
	$base_dir = dirname(__FILE__);
	$base_url = '/';
	$user_domain = 'fcite.com';
	$home_page = '1';
	$mod_rewrite = true;
	$show_comments = false;
	$comment_callback = "http://uk.zyro.com/comment_callback/";
	$user_key = "o6vvTjg4cEYy";
	$user_hash = "49012637b15069ea";
